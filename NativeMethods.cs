...
public partial class NativeMethods : GodotObject
{
    ...
    public delegate int EnumDesktopWindowsDelegate(IntPtr hWnd, int lParam);
    ...
    //http://www.pinvoke.net/default.aspx/Enums/SPIF.html
    [Flags]
    public enum SPIF
    {
        None = 0x00,
    ...
    //http://www.pinvoke.net/default.aspx/Structures/ANIMATIONINFO.html
    /// <summary>
